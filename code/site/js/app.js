...
const API_URL_CADASTRO = 'http://localhost:5000/cadastro';
const API_URL_DADOS = 'http://localhost:5000/dados?order=asc&id=' + obterDadosCadastroId();
const API_URL_DADOS_POST_DELETE = 'http://localhost:5000/dados';
